...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{ url('admin/shifts') }}">اوقات العمل</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <span>عرض اوقات العمل</span>
        </li>
    </ul>
</div>

<h1 class="page-title"> اوقات العمل
    {{--<small>عرض جميع اوقات العمل</small>--}}
</h1>
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="btn-group">
                                <a class="btn sbold green" href="{{ route('shifts.create') }}"> إضافة جديد
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-left" role="menu">
                                        ...
                                        <li>
                                            <a href="{{ route('shifts.edit',['id'=>$record]) }}">
    ...
    $( document ).ready(function () {
            $('body').on('click', '.delete_data', function() {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/admin/shifts/"+id+"/delete" ;
