...
<h1 class="page-title"> الكوبونات
    {{--<small>عرض جميع الكوبونات</small>--}}
</h1>
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="btn-group">
                                <a class="btn sbold green" href="{{ route('coupons.create') }}"> إضافة جديد
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column"
                    ...
                    <tbody>
                        ...
                        {{-- @php
                        $count = App\Order::where('status',1)->where('discount_code','like',$record->name)->count();
                        @endphp --}}
                        <tr class="odd gradeX">
                            <td>
                                <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                            ...
                            <td class="no_dec">{{ $record->percentage }}</td>
                            <td class="no_dec">{{ $count=0 }}</td>
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-left" role="menu">
                                        <li>
                                            <a href="{{ route('coupons.edit',['id'=>$record]) }}">
