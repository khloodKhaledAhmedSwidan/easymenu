            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light ">
                        <form role="form" action="{{route('meals.store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-pane active" id="tab_1_1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name_ar" class="form-control"
                                                placeholder="أسم الوجبة" value="{{old('name_ar')}}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="content_ar" class="form-control"
                                                placeholder="وصف الوجبة" value="{{old('content_ar')}}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="content" class="form-control"
                                                placeholder="وصف الوجبة" value="{{old('content')}}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="price" class="form-control"
                                                placeholder="سعر الوجبة" value="{{old('price')}}" />
                                            @if ($errors->has('price'))
                                            <span class="help-block">
