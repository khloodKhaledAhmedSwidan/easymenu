            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="btn-group">
                                <a class="btn sbold green" href="{{ route('seller-code.create') }}"> إضافة جديد
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column"
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td class="no_dec">
                                <a href="{{route('seller-code.show',$record->id)}}" class="btn btn-info">
                                    {{ $record->seller_name }}
                                </a>
                            </td>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-left" role="menu">
                                        <li>
                                            <a href="{{ route('seller-code.edit',['id'=>$record]) }}">
    ...
    $( document ).ready(function () {
            $('body').on('click', '.delete_data', function() {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/admin/seller-code/"+id+"/delete";
                });
            });
        });
</script>
