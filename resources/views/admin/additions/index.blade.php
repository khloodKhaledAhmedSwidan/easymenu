...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{ url('admin/additions') }}">الاضافات</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <span>عرض الاضافات</span>
        </li>
    </ul>
</div>

<h1 class="page-title"> الاضافات
    {{--<small>عرض جميع الاضافات</small>--}}
</h1>
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="btn-group">
                                <a class="btn sbold green" href="{{ route('additions.create') }}"> إضافة جديد
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column"
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td class="no_dec">{{ $record->type == 0 ? 'اساسية':'اضافيه' }}</td>
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-left" role="menu">
                                        ...
                                        <li>
                                            <a href="{{ route('additions.edit',['id'=>$record]) }}">
    ...
    $( document ).ready(function () {
            $('body').on('click', '.delete_data', function() {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/admin/additions/"+id+"/delete" ;
