...
<h1 class="page-title"> تعديل الصفحة
    <small> تعديل الصفحة </small>
</h1>
@endsection
...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        {!! Form::open(['action'=>['AdminController\PagesController@update'
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea type="text" id="description2" class="form-control"
                                            placeholder="المحتوي" name="content">{{$page->content}}</textarea>
                                    </div>
                                </div>
